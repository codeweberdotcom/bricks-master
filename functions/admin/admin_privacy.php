...
<!-- wp:heading {"level":3} -->
<h3 class="wp-block-heading">5. Перечень используемых на сайте файлов cookie</h3>
<!-- /wp:heading -->

<!-- wp:paragraph -->
<p>5.1. Ниже приведён перечень файлов cookie, которые могут использоваться на сайте Оператора. Назначение, срок хранения и категория указаны для информирования Пользователя. Актуальный перечень формируется на основании данных, полученных с помощью инструмента Cookie Scanner в настройках темы.</p>
<!-- /wp:paragraph -->

<!-- wp:shortcode -->
[codeweber_cookie_table]
<!-- /wp:shortcode -->
...
<!-- wp:heading {"level":3} -->
<h3 class="wp-block-heading">6. Управление файлами cookie</h3>
<!-- /wp:heading -->

<!-- wp:paragraph -->
<p>6.1. Пользователь может самостоятельно ограничить или полностью отключить использование файлов cookie через настройки браузера. При этом Оператор предупреждает, что в таком случае возможна некорректная работа сайта и ограничение доступа к некоторым функциям.</p>
<!-- /wp:paragraph -->

<!-- wp:paragraph -->
<p>6.2. Для управления файлами cookie Пользователь может использовать стандартные средства браузера, в том числе очистку cookie и настройку блокировки.</p>
<!-- /wp:paragraph -->
...
<!-- wp:heading {"level":3} -->
<h3 class="wp-block-heading">7. Обработка персональных данных с использованием файлов cookie</h3>
<!-- /wp:heading -->

<!-- wp:paragraph -->
<p>7.1. Файлы cookie могут содержать идентификаторы, позволяющие осуществлять сбор и обработку персональных данных Пользователей в целях, указанных в разделе 3.</p>
<!-- /wp:paragraph -->

<!-- wp:paragraph -->
<p>7.2. Обработка персональных данных с использованием файлов cookie осуществляется Оператором в соответствии с требованиями законодательства Российской Федерации, в частности с Законом о персональных данных и Федеральным законом № 149-ФЗ «Об информации, информационных технологиях и о защите информации».</p>
<!-- /wp:paragraph -->

<!-- wp:paragraph -->
<p>7.3. Сведения, собираемые с помощью файлов cookie, не включают персональные данные без согласия Пользователя, за исключением случаев, прямо предусмотренных законом.</p>
<!-- /wp:paragraph -->
...
<!-- wp:heading {"level":3} -->
<h3 class="wp-block-heading">8. Хранение и защита данных</h3>
<!-- /wp:heading -->

<!-- wp:paragraph -->
<p>8.1. Оператор обеспечивает технические и организационные меры по защите персональных данных, обрабатываемых с использованием файлов cookie, от несанкционированного доступа, уничтожения, изменения, блокирования и распространения.</p>
<!-- /wp:paragraph -->

<!-- wp:paragraph -->
<p>8.2. Файлы cookie хранятся на устройствах Пользователей в течение времени, указанного в сроках их действия, или до удаления Пользователем.</p>
<!-- /wp:paragraph -->
...
<!-- wp:heading {"level":3} -->
<h3 class="wp-block-heading">9. Заключительные положения</h3>
<!-- /wp:heading -->

<!-- wp:paragraph -->
<p>9.1. Оператор вправе вносить изменения в настоящую Политику в связи с изменениями законодательства, техническими обновлениями сайта или иными причинами.</p>
<!-- /wp:paragraph -->

<!-- wp:paragraph -->
<p>9.2. Актуальная версия Политики всегда доступна на сайте Оператора по адресу, указанному в пункте 1.4.</p>
<!-- /wp:paragraph -->

<!-- wp:paragraph -->
<p>9.3. Пользователь обязуется самостоятельно ознакомиться с Политикой и соблюдать её положения.</p>
<!-- /wp:paragraph -->
