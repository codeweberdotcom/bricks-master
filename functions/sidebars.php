 ...
 * Можно отключить из дочерней темы: remove_action('codeweber_after_widget', 'codeweber_sidebar_widget_legal');
 */
...
add_action('codeweber_after_widget', 'codeweber_sidebar_widget_legal');

/**
 * Виджет сайдбара для Vacancies
 * Можно отключить из дочерней темы: remove_action('codeweber_after_widget', 'codeweber_sidebar_widget_vacancies');
 */
 ...
 * Можно отключить из дочерней темы: remove_action('codeweber_after_sidebar', 'codeweber_sidebar_widget_faq');
 */
...
add_action('codeweber_after_sidebar', 'codeweber_sidebar_widget_faq');
