...
(function () {
	...
	class CodeweberYandexMapsV3 {
		...
		buildBalloon( markerData ) {
			...
			div.style.cssText = `position:absolute;bottom:22px;left:7px;transform:translateX(-50%);background:#fff;border-radius:8px;box-shadow:0 2px 12px rgba(0,0,0,.18);padding:12px 16px;min-width:280px;max-width:${ maxWidth }px;z-index:100;white-space:normal;`;
			div.innerHTML = `
