...
function render_license_details_meta_box($post)
{
   ...
   $license_provider = get_post_meta($post->ID, '_license_provider', true);
   $license_guid = get_post_meta($post->ID, '_license_guid', true);
   $license_resource_id = get_post_meta($post->ID, '_license_resource_id', true);
   $license_ai_generated = get_post_meta($post->ID, '_license_ai_generated', true);
...
?>
   ...
   <table class="form-table">
      ...
      <tr>
         <th scope="row">
            <label for="license_provider"><?php _e('Provider / source:', 'codeweber'); ?></label>
         </th>
         <td>
            <input type="text" id="license_provider" name="license_provider" value="<?php echo esc_attr($license_provider); ?>" class="regular-text">
            <p class="description"><?php _e('Stock source, e.g. Vecteezy, Pexels, Pixabay', 'codeweber'); ?></p>
         </td>
      </tr>

      <tr>
         <th scope="row">
            <label for="license_guid"><?php _e('License ID / GUID:', 'codeweber'); ?></label>
         </th>
         <td>
            <input type="text" id="license_guid" name="license_guid" value="<?php echo esc_attr($license_guid); ?>" class="regular-text">
            <p class="description"><?php _e('Unique license identifier issued by the provider', 'codeweber'); ?></p>
         </td>
      </tr>

      <tr>
         <th scope="row">
            <label for="license_resource_id"><?php _e('Provider resource ID:', 'codeweber'); ?></label>
         </th>
         <td>
            <input type="text" id="license_resource_id" name="license_resource_id" value="<?php echo esc_attr($license_resource_id); ?>" class="regular-text">
            <p class="description"><?php _e('Asset ID on the provider\'s site', 'codeweber'); ?></p>
         </td>
      </tr>

      <tr>
         <th scope="row">
            <label for="license_ai_generated"><?php _e('AI-generated:', 'codeweber'); ?></label>
         </th>
         <td>
            <label>
               <input type="checkbox" id="license_ai_generated" name="license_ai_generated" value="1" <?php checked($license_ai_generated, '1'); ?>>
               <?php _e('This asset was generated by AI', 'codeweber'); ?>
            </label>
         </td>
      </tr>
   </table>
...
function save_license_meta($post_id)
{
   ...
   $fields = array(
      ...
      'item_url' => '_item_url',
      'license_provider' => '_license_provider',
      'license_guid' => '_license_guid',
      'license_resource_id' => '_license_resource_id'
   );
   ...
   update_post_meta($post_id, '_license_ai_generated', isset($_POST['license_ai_generated']) ? '1' : '');
