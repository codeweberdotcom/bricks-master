...
if (! function_exists('codeweber_image_settings')) {
	function codeweber_image_settings()
	{
		...
		add_image_size('codeweber_event_200-133', 200, 133, true); // Swiper gallery thumbs
...
function codeweber_get_allowed_image_sizes($post_type = '', $post_id = 0)
{
	...
	$default_sizes = [
		...
		'events'    => ['codeweber_event_900-450', 'codeweber_event_400-267', 'codeweber_event_200-133', 'codeweber_vacancy', 'codeweber_avatar', 'woocommerce_gallery_thumbnail'],
