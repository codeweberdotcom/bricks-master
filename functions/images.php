...
if (! function_exists('codeweber_image_settings')) {
	function codeweber_image_settings()
	{
		...
		add_image_size('codeweber_event_96-60',    96,  60,  true); // Swiper gallery thumbs (8 per row)
...
function codeweber_get_allowed_image_sizes($post_type = '', $post_id = 0)
{
	...
	$default_sizes = [
		...
		'events'    => ['codeweber_event_1070-668', 'codeweber_event_400-267', 'codeweber_event_96-60', 'codeweber_vacancy', 'codeweber_avatar', 'woocommerce_gallery_thumbnail'],
