...
?>
   <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 20px;">
      ...
      <div>
         <label for="vacancy_cf7_form_id" style="display: block; margin-bottom: 5px; font-weight: bold;">
         ...
         if ($cf7_plugin_active && class_exists('WPCF7_ContactForm')) {
            ...
            foreach ($cf7_posts as $cf7_post) {
               $cf7_forms[$cf7_post->ID] = $cf7_post->post_title;
            }
         }
         ?>
...
?>
   ...
   <div style="margin-bottom: 15px;">
      ...
      <div style="position:relative;margin-bottom:12px;">
         <input type="text" id="vacancy-map-search" placeholder="<?php esc_attr_e( 'Search address...', 'codeweber' ); ?>"
      ...
      <?php if (!empty($yandex_api_key)) : ?>
         ...
         (function() {
            ...
            ymaps3.ready.then(function() {
               ...
               var latField     = document.getElementById('vacancy_latitude');
               var lngField     = document.getElementById('vacancy_longitude');
               var zoomField    = document.getElementById('vacancy_zoom');
               var addressField = document.getElementById('vacancy_yandex_address');
               var searchInput  = document.getElementById('vacancy-map-search');
               ...
               var map = new YMap(document.getElementById('vacancy-yandex-map'), {
