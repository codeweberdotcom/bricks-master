...
$opt_name = 'codeweber';  // YOU MUST CHANGE THIS.  DO NOT USE 'redux_demo' IN YOUR PROJECT!!!
...
$args = array(
	...
	'display_name'              => $theme->get( 'Codeweber' ),

	// Version that appears at the top of your panel.
	'display_version'           => $theme->get( '0.2.0' ),
	...
	'menu_title'                => esc_html__( 'Sample Options', 'redux-framework' ),

	// The text to appear on the page title.
	'page_title'                => esc_html__( 'Sample Options', 'redux-framework' ),
	...
	'footer_credit'             => 'Разработано Codeweber.ru тел. +7(949) 341-05-66',
...
if ( ! isset( $args['global_variable'] ) || false !== $args['global_variable'] ) {
	...
	$args['intro_text'] = '<p>' . sprintf( esc_html__( 'Did you know that Redux sets a global variable for you? To access any of your saved options from within your code you can use your global variable: $%1$s', 'redux-framework' ), '<strong>' . $v . '</strong>' ) . '<p>';
} else {
	$args['intro_text'] = '<p>' . esc_html__( 'This text is displayed above the options panel. It isn\'t required, but more info is always better! The intro_text field accepts all HTML.', 'redux-framework' ) . '</p>';
}

// Add content after the form.
$args['footer_text'] = '<p>' . esc_html__( 'This text is displayed below the options panel. It isn\'t required, but more info is always better! The footer_text field accepts all HTML.', 'redux-framework' ) . '</p>';
...
$help_tabs = array(
	array(
		...
		'content' => '<p>' . esc_html__( 'This is the tab content, HTML is allowed.', 'redux-framework' ) . '</p>',
	),
	array(
		'id'      => 'redux-help-tab-2',
...
$content = '<p>' . esc_html__( 'This is the sidebar content, HTML is allowed.', 'redux-framework' ) . '</p>';
...
Redux::set_section(
	$opt_name,
	array(
		'title'            => esc_html__( 'Basic Fields', 'redux-framework' ),
		'id'               => 'basic',
		'desc'             => esc_html__( 'These are really basic fields!', 'redux-framework' ),
...
Redux::set_section(
	$opt_name,
	array(
		'title'            => esc_html__( 'Editors', 'redux-framework' ),
		'id'               => 'editor',
...
Redux::set_section(
	$opt_name,
	array(
		'title' => esc_html__( 'Color Selection', 'redux-framework' ),
		'id'    => 'color',
		'icon'  => 'el el-brush',
	)
);
...
Redux::set_section(
	$opt_name,
	array(
		'title' => esc_html__( 'Design Fields', 'redux-framework' ),
		'id'    => 'design',
		'icon'  => 'el el-wrench',
	)
);
...
Redux::set_section(
	$opt_name,
	array(
		'title' => esc_html__( 'Media Uploads', 'redux-framework' ),
		'id'    => 'media',
		'icon'  => 'el el-picture',
	)
);
...
Redux::set_section(
	$opt_name,
	array(
		'title' => esc_html__( 'Presentation Fields', 'redux-framework' ),
		'id'    => 'presentation',
		'icon'  => 'el el-screen',
	)
);
...
Redux::set_section(
	$opt_name,
	array(
		'title' => esc_html__( 'Switch / Button Set', 'redux-framework' ),
		'id'    => 'switch_buttonset',
		'icon'  => 'el el-cogs',
	)
);
...
Redux::set_section(
	$opt_name,
	array(
		'title' => esc_html__( 'Select Fields', 'redux-framework' ),
		'id'    => 'select',
		'icon'  => 'el el-list-alt',
	)
);
...
Redux::set_section(
	$opt_name,
	array(
		'title' => esc_html__( 'Disabling', 'redux-framework' ),
		'icon'  => 'el el-lock',
	)
);
...
Redux::set_section(
	$opt_name,
	array(
		'title' => esc_html__( 'Redux Extensions', 'redux-framework' ),
		'id'    => 'redux-extensions',
		'icon'  => 'el el-redux',
		'class' => 'pro_highlight',
		'desc'  => esc_html__( 'For full documentation on this field, visit: ', 'redux-framework' ) . '<a href="https://devs.redux.io/core-extensions/" target="_blank">https://devs.redux.io/core-extensions/</a>',
	)
);
...
Redux::set_section(
	...
	array(
		...
		'desc'            => '<p class="description">' . esc_html__( 'This Section should be visible only in Customizer', 'redux-framework' ) . '</p>',
