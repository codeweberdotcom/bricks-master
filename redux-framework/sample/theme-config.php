...
$opt_name = 'redux_demo';  // YOU MUST CHANGE THIS.  DO NOT USE 'codeweber' IN YOUR PROJECT!!!
...
$args = array(
	...
	'menu_title'                => esc_html__( 'Theme Options', 'codeweber' ),

	// The text to appear on the page title.
	'page_title'                => esc_html__('Theme Options', 'codeweber' ),
...
$args['admin_bar_links'][] = array(
	'id'    => 'redux-docs',
	'href'  => '//devs.redux.io/',
	'title' => __( 'Documentation', 'codeweber' ),
);

$args['admin_bar_links'][] = array(
	'id'    => 'redux-support',
	'href'  => '//github.com/ReduxFramework/redux-framework/issues',
	'title' => __( 'Support', 'codeweber' ),
);
...
$help_tabs = array(
	array(
		'id'      => 'redux-help-tab-1',
		'title'   => esc_html__( 'Theme Information 1', 'codeweber' ),
		'content' => '<p>' . esc_html__( 'This is the tab content, HTML is allowed.', 'codeweber' ) . '</p>',
	),
	array(
		'id'      => 'redux-help-tab-2',
		'title'   => esc_html__( 'Theme Information 2', 'codeweber' ),
		'content' => '<p>' . esc_html__( 'This is the tab content, HTML is allowed.', 'codeweber' ) . '</p>',
	),
);
...
$content = '<p>' . esc_html__( 'This is the sidebar content, HTML is allowed.', 'codeweber' ) . '</p>';
...
/*
 * ---> START CODEWEBER SECTIONS
 */

Redux::set_section(
	$opt_name,
	array(
		'title'            => esc_html__("Custom Post Type", "codeweber"),
		'id'               => 'cpt',
		'desc'             => esc_html__("Settings CPT posts", "codeweber"),
...
require_once Redux_Core::$dir . '../sample/sections/codeweber/proxy.php';
