	...
	array(
		...
		'fields' => array(
			...
			array(
				...
				'desc'    => __('Russia — the banner is informational, tracking works immediately. GDPR — tracking is blocked until the user consents.', 'codeweber'),
				'options' => array(
					'ru'   => __('Russia (152-FZ)', 'codeweber'),
			...
			array(
				...
				'desc'       => __('Increase the value to show the banner again to all visitors (e.g., when the policy is updated).', 'codeweber'),
				'default'    => '1',
