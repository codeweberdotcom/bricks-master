<?php
// Не выводим заголовок на блог-ленте (is_home, не singular) и 404.
// Статическая главная (is_singular) обрабатывается как обычная страница,
// чтобы работали per-post настройки заголовка (Стандартный/Пользовательский/Отключить).
