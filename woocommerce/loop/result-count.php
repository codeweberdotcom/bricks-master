 ...
 *
 * Переопределяет стандартный WC result count.
 * Добавляет классы mb-0 text-muted (Bootstrap 5) в стиле темы.
 *
 * @package Codeweber
 * @version 9.9.0
 */
...
?>
<p class="woocommerce-result-count mb-0 text-muted" role="alert" aria-relevant="all" <?php echo ( empty( $orderedby ) || 1 === intval( $total ) ) ? '' : 'data-is-sorted-by="true"'; ?>>
	<?php
