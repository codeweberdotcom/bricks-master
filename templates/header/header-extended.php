...
$config = [
    ...
    'social-type-mobile-menu' => 'type1', //type1, type2, type3, type4, type5
    'social-size' => 'sm', //sm, md, lg
    'btn-close-mobile' => 'btn-close-white',
    'btn-close-offcanvas' => 'btn-close-white',
...
<header class="wrapper <?= implode(" ", $header_class); ?>">
        ...
        <div class="container flex-lg-column">
            ...
            <div class="navbar-collapse-wrapper d-flex flex-row align-items-center <?= implode(" ", $header_navbar_wrapper_class); ?>">
                ...
                <div class="navbar-other ms-auto w-100 d-none d-lg-block">
                    ...
                    <?php } else {; ?>
                        <?= codeweber_social_links('justify-content-end text-end', $config['social-type'], $config['social-button-size-offcanvas'], 'primary', 'solid', $config['social-button-style-offcanvas']); ?>
                    <?php } ?>
                </div>
                <!-- /.navbar-other -->
            </div>
