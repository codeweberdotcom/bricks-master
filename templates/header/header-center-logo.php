...
<header class="wrapper <?= $config['header-bg-color']; ?>">
    ...
    <nav class="navbar navbar-expand-lg  center-logo <?= implode(" ", $header_navbar_class); ?>">
        <div class="container justify-content-between align-items-center">
            ...
            <!-- /.d-flex -->
            <div class="navbar-collapse-wrapper d-flex flex-row align-items-center w-100 <?= implode(" ", $header_navbar_wrapper_class); ?>">
                <div class="navbar-collapse-inner d-flex flex-row align-items-center w-100 mt-0">
                    <div class="navbar-collapse offcanvas offcanvas-nav offcanvas-start <?= implode(" ", $navbar_collapse_class); ?>">
                        ...
                        <div class="w-100 order-1 order-lg-0 d-lg-flex offcanvas-body">
                            ...
                            <?php
                            $_cl_theme = Redux::get_option( $opt_name, 'mobile-menu-background' ) === '2' ? 'navbar-dark' : 'navbar-light';
                            wp_nav_menu(
                                array(
                                    'theme_location'  => $config['mainMenuName'],
                                    'depth'           => 4,
                                    'container'       => 'nav',
                                    'container_class' => 'navbar-vertical menu-collapse-nav d-lg-none ' . $_cl_theme,
