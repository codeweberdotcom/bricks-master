<?php
/**
 * Template: Testimonial Quote with Avatar (borderless, no card, no icon)
 *
 * Borderless large quote with a centered avatar + author block.
 *
...
<blockquote class="border-0 fs-lg text-center">
    ...
    <div class="blockquote-details justify-content-center">
        ...
        <?php endif; ?>
        <div class="info<?php echo empty($post_data['avatar_url']) ? ' p-0' : ''; ?>">
