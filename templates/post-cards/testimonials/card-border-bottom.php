<?php
/**
 * Template: Testimonial Card Border Bottom (shadow + colored bottom border)
 *
 * Card with shadow and a colored bottom border, quote with icon, no avatar.
 *
...
$card_classes = 'card shadow-lg card-border-bottom border-soft-primary';
