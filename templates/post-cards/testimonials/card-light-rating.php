<?php
/**
 * Template: Testimonial Card Light Rating (translucent light card for dark backgrounds)
 *
 * Borderless translucent card (bg-white-900) with rating and borderless quote,
 * no avatar. Designed to sit on dark or image sections.
 *
...
$card_classes = 'card border-0 bg-white-900';
