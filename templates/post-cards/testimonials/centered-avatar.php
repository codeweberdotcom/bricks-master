<?php
/**
 * Template: Testimonial Centered with Avatar (icon-top, no card)
 *
 * Borderless centered quote with top icon and a centered avatar + author block.
 *
...
<blockquote class="icon icon-top fs-lg text-center">
    ...
    <div class="blockquote-details justify-content-center">
        ...
        <?php endif; ?>
        <div class="info<?php echo empty($post_data['avatar_url']) ? ' ps-0' : ''; ?>">
