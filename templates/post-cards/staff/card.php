<?php
/**
 * Template: Staff Card (Sandbox Style with Colored Backgrounds)
 * 
 * Карточка сотрудника в стиле Sandbox с цветными фонами
 * Основано на: https://sandbox.elemisthemes.com/docs/blocks/team.html - "Our Team"
 * 
...
$template_args = wp_parse_args($template_args ?? [], [
    'bg_color' => '', // bg-soft-blue, bg-soft-red, bg-soft-green, bg-soft-violet
...
// Если цвет не указан, выбираем на основе ID
if (empty($template_args['bg_color'])) {
    $bg_colors = ['bg-soft-blue', 'bg-soft-red', 'bg-soft-green', 'bg-soft-violet'];
...
$card_html = '<div class="position-relative">
    <div class="shape rounded ' . esc_attr($template_args['bg_color']) . ' rellax d-md-block" data-rellax-speed="0" style="bottom: -0.75rem; right: -0.75rem; width: 98%; height: 98%; z-index:0"></div>
