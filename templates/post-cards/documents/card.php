 ...
 * 
 * Уникальный шаблон карточки документа на основе overlay-5
 * С кнопкой загрузки документа вместо "Read more"
    ...
    <?php if ($post_data['image_url']) : ?>
        <figure class="<?php echo esc_attr($template_args['hover_classes']); ?><?php echo $card_radius ? ' ' . esc_attr($card_radius) : ''; ?>">
            <a href="<?php echo esc_url($post_data['link']); ?>">
                ...
                <img src="<?php echo esc_url($post_data['image_url']); ?>" alt="<?php echo esc_attr($post_data['image_alt']); ?>" class="<?php echo $card_radius ? esc_attr($card_radius) : 'rounded'; ?>">
            </a>
                        ...
                        <?php if ($document_file_url) : ?>
                            <a href="javascript:void(0)"
                               ...
                               data-value="doc-<?php echo esc_attr($post_data['id']); ?>">
                                <i class="uil uil-envelope fs-15"></i>
                                <span class="ms-1"><?php esc_html_e('Send to Email', 'codeweber'); ?></span>
                            </a>
                        <?php else : ?>
