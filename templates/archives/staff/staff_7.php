<?php
/**
 * Archive template: Staff — Style 7 (horizontal cards + city filter)
 *
 * Based on staff_6. Filter by city: if staff has an office, city comes from
...
(function () {
	...
	cityBtns.forEach(function (btn) {
		btn.addEventListener('click', function () {
			...
			body.append('params',     JSON.stringify({ post_type: 'staff', template: 'staff_7', filters: filters }));
