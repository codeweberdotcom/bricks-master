<?php
/**
 * Template: Services Archive — Style 5 (Overlay-5, 4 columns + category filter, col-6 on mobile)
 *
 * @package Codeweber
 */
					...
					<figure class="overlay overlay-5 <?php echo esc_attr( $card_radius ); ?> card-interactive mb-0">
						...
						<figcaption class="p-5">
							<div class="post-body h-100 d-flex flex-column from-left justify-content-end">
								<?php if ( $short_desc ) : ?>
									<p class="mb-3 d-none d-md-block"><?php echo wp_kses( $short_desc, [ 'br' => [] ] ); ?></p>
								<?php endif; ?>
...
(function () {
	...
	catBtns.forEach(function (btn) {
		btn.addEventListener('click', function (e) {
			...
			body.append('params',     JSON.stringify({ post_type: 'services', template: 'services_5', filters: filters }));
