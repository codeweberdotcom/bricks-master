<?php
/**
 * Template: Projects Archive — Style 3
 * Isotope grid with category filter, square images.
 *
 * @package Codeweber
 */
...
$grid_gap    = class_exists( 'Codeweber_Options' ) ? Codeweber_Options::style( 'grid-gap' ) : 'gx-md-10 gy-10 gy-md-13';
