<?php
/**
 * Template: Projects Archive — Style 2
 * AJAX category filter + paginated grid (3-col, square images).
 *
 * @package Codeweber
 */
	...
	<div class="container py-14 py-md-16">
		...
		<div id="projects-grid-results">
			...
			<div class="row <?php echo esc_attr( $grid_gap ); ?>">
				...
				?>
				<div class="project col-md-6 col-xl-4">
					<?php if ( $thumbnail_id ) : ?>
					<figure class="lift <?php echo esc_attr( $card_radius ); ?> mb-6">
						<a href="<?php the_permalink(); ?>">
							<?php echo wp_get_attachment_image( $thumbnail_id, 'cw_square_lg', false, [ 'class' => 'w-100', 'alt' => esc_attr( get_the_title() ) ] ); ?>
						</a>
					</figure>
					<?php endif; ?>
...
(function () {
	...
	catBtns.forEach(function (btn) {
		btn.addEventListener('click', function (e) {
			...
			body.append('params',     JSON.stringify({ post_type: 'projects', template: 'projects_2', filters: filters }));
