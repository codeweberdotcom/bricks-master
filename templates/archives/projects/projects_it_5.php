<?php
/**
 * Template: Projects Archive — IT / Web (Circle button)
 *
 * AJAX category filter + 3-col grid with browser mockup cards.
 * Quick View: compact circle icon button, bottom-right, appears on hover.
 *
 * @package Codeweber
 */
				...
				<div class="col-md-6 col-xl-4">
					<div class="card h-100 overflow-hidden <?php echo esc_attr( $card_radius ); ?>">
						...
						<div class="position-relative">
							...
							<?php if ( $website_url ) : ?>
							<button type="button"
								class="cw-it-qv btn btn-circle btn-sm btn-white has-ripple"
...
(function () {
	...
	catBtns.forEach(function (btn) {
		btn.addEventListener('click', function (e) {
			...
			body.append('params',     JSON.stringify({ post_type: 'projects', template: 'projects_it_5', filters: filters }));
