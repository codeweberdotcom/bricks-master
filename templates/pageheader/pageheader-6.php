...
if ($page_header_align === '1') {
   ...
   $col_class[] = 'col-lg-8 mx-auto mb-11';
...
if ($global_header_model === '7' || $global_header_model === '8') {
   if ($header_background === '3') {
      $container_class[] = 'pt-18 pb-18 pb-md-20 pt-md-22 pb-lg-21';
   } else {
      $container_class[] = 'pt-16 pb-18 pb-md-20 pt-md-17 pb-lg-21';
   }
} elseif ($global_header_model === '1' || $global_header_model === '2' ||  $global_header_model === '3') {
   if ($header_background === '3') {
      $container_class[] = 'pt-18 pb-18 pb-md-20 pt-md-20 pb-lg-21';
   } else {
      $container_class[] = 'pt-16 pb-18 pb-md-20 pt-md-16 pb-lg-21';
   }
} elseif ($global_header_model === '4' || $global_header_model === '5' ||  $global_header_model === '6') {
   if ($header_background === '3') {
      $container_class[] = 'pt-20 pb-18 pb-md-20 pt-md-21 pb-lg-21';
   } else {
      $container_class[] = 'pt-16 pb-18 pb-md-20 pt-md-16 pb-lg-21';
   }
}else{
   if ($header_background === '3') {
      $container_class[] = 'pt-16 pb-18 pb-md-20 pt-md-20 pb-lg-21';
   } else {
      $container_class[] = 'pt-10 pb-18 pb-md-20 pt-md-14 pb-lg-21';
   }
}
?>
