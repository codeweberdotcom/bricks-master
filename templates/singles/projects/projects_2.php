 ...
 * Структура:
 * 1. Page Header
 * 2. Шапка (категория, заголовок, краткое описание) — bg-soft-primary
 * 3. Контент: Swiper-слайдер (главное фото + галерея), описание + выполненные работы + метаполя
					...
					<div class="swiper">
						<div class="swiper-wrapper">
							<?php foreach ( $slide_ids as $slide_id ) :
								$slide_url  = wp_get_attachment_image_url( $slide_id, 'codeweber_extralarge' );
