        ...
        <div class="card h-100<?php echo $card_radius ? ' ' . esc_attr($card_radius) : ''; ?>">
            <div class="card-body">
                ...
                <div class="row g-3">
                    ...
                    <div class="col-md-6">
                        <?php if (!empty($job_phone)) : ?>
                            <a href="tel:<?php echo esc_attr(preg_replace('/[^0-9+]/', '', $job_phone)); ?>" class="btn btn-icon btn-icon-start btn-outline-primary justify-content-between d-flex w-100 mb-2 has-ripple<?php echo esc_attr($button_class); ?>">
                                <i class="uil uil-phone-alt"></i> <?php esc_html_e('Work Phone', 'codeweber'); ?>
                            </a>
                        <?php endif; ?>

                        <?php if (!empty($phone)) : ?>
                            <a href="tel:<?php echo esc_attr(preg_replace('/[^0-9+]/', '', $phone)); ?>" class="btn btn-icon btn-icon-start btn-outline-primary justify-content-between d-flex w-100 mb-2 has-ripple<?php echo esc_attr($button_class); ?>">
                                <i class="uil uil-phone"></i> <?php esc_html_e('Phone', 'codeweber'); ?>
                            </a>
                        <?php endif; ?>

                        <?php if (!empty($email)) : ?>
                            <a href="mailto:<?php echo esc_attr($email); ?>" class="btn btn-icon btn-icon-start btn-outline-primary justify-content-between d-flex w-100 mb-2 has-ripple<?php echo esc_attr($button_class); ?>">
                                <i class="uil uil-envelope"></i> <?php esc_html_e('Email', 'codeweber'); ?>
                            </a>
                        <?php endif; ?>

                        <?php if (!empty($website)) : ?>
                            <a href="<?php echo esc_url($website); ?>" target="_blank" rel="noopener" class="btn btn-icon btn-icon-start btn-outline-primary justify-content-between d-flex w-100 mb-2 has-ripple<?php echo esc_attr($button_class); ?>">
                                <i class="uil uil-globe"></i> <?php esc_html_e('Website', 'codeweber'); ?>
                            </a>
                        <?php endif; ?>
                    </div>
                    <!--/column -->
                    ...
                    <div class="col-md-6">
                        <?php if (!empty($telegram)) : ?>
                            <a href="<?php echo esc_url($telegram); ?>" target="_blank" rel="noopener" class="btn btn-icon btn-icon-start btn-outline-primary justify-content-between d-flex w-100 mb-2 has-ripple<?php echo esc_attr($button_class); ?>">
                                <i class="uil uil-telegram-alt"></i> <?php esc_html_e('Telegram', 'codeweber'); ?>
                            </a>
                        <?php endif; ?>

                        <?php if (!empty($whatsapp)) : ?>
                            <a href="<?php echo esc_url($whatsapp); ?>" target="_blank" rel="noopener" class="btn btn-icon btn-icon-start btn-outline-primary justify-content-between d-flex w-100 mb-2 has-ripple<?php echo esc_attr($button_class); ?>">
                                <i class="uil uil-whatsapp"></i> <?php esc_html_e('WhatsApp', 'codeweber'); ?>
                            </a>
                        <?php endif; ?>

                        <?php if (!empty($vk)) : ?>
                            <a href="<?php echo esc_url($vk); ?>" target="_blank" rel="noopener" class="btn btn-icon btn-icon-start btn-outline-primary justify-content-between d-flex w-100 mb-2 has-ripple<?php echo esc_attr($button_class); ?>">
                                <i class="uil uil-vk"></i> <?php esc_html_e('VKontakte', 'codeweber'); ?>
                            </a>
                        <?php endif; ?>

                        <?php if (!empty($facebook)) : ?>
                            <a href="<?php echo esc_url($facebook); ?>" target="_blank" rel="noopener" class="btn btn-icon btn-icon-start btn-outline-primary justify-content-between d-flex w-100 mb-2 has-ripple<?php echo esc_attr($button_class); ?>">
                                <i class="uil uil-facebook-f"></i> <?php esc_html_e('Facebook', 'codeweber'); ?>
                            </a>
                        <?php endif; ?>

                        <?php if (!empty($twitter)) : ?>
                            <a href="<?php echo esc_url($twitter); ?>" target="_blank" rel="noopener" class="btn btn-icon btn-icon-start btn-outline-primary justify-content-between d-flex w-100 mb-2 has-ripple<?php echo esc_attr($button_class); ?>">
                                <i class="uil uil-twitter"></i> <?php esc_html_e('Twitter', 'codeweber'); ?>
                            </a>
                        <?php endif; ?>

                        <?php if (!empty($linkedin)) : ?>
                            <a href="<?php echo esc_url($linkedin); ?>" target="_blank" rel="noopener" class="btn btn-icon btn-icon-start btn-outline-primary justify-content-between d-flex w-100 mb-2 has-ripple<?php echo esc_attr($button_class); ?>">
                                <i class="uil uil-linkedin"></i> <?php esc_html_e('LinkedIn', 'codeweber'); ?>
                            </a>
                        <?php endif; ?>

                        <?php if (!empty($instagram)) : ?>
                            <a href="<?php echo esc_url($instagram); ?>" target="_blank" rel="noopener" class="btn btn-icon btn-icon-start btn-outline-primary justify-content-between d-flex w-100 mb-2 has-ripple<?php echo esc_attr($button_class); ?>">
                                <i class="uil uil-instagram"></i> <?php esc_html_e('Instagram', 'codeweber'); ?>
                            </a>
                        <?php endif; ?>

                        <?php if (!empty($skype)) : ?>
                            <a href="<?php echo esc_url($skype); ?>" target="_blank" rel="noopener" class="btn btn-icon btn-icon-start btn-outline-primary justify-content-between d-flex w-100 mb-2 has-ripple<?php echo esc_attr($button_class); ?>">
                                <i class="uil uil-skype"></i> <?php esc_html_e('Skype', 'codeweber'); ?>
                            </a>
                        <?php endif; ?>

                        <?php if ($qrcode_url) : ?>
                            <a href="<?php echo esc_url($qrcode_url); ?>" data-glightbox data-gallery="staff-qrcode" title="<?php echo esc_attr($full_name . ' - ' . __('QR Code', 'codeweber')); ?>" class="btn btn-icon btn-icon-start btn-outline-primary justify-content-between d-flex w-100 mb-2 has-ripple<?php echo esc_attr($button_class); ?>">
                ...
                <div class="d-flex justify-content-end">
                    <a href="javascript:void(0)" class="btn btn-icon btn-icon-start btn-outline-primary justify-content-between d-flex has-ripple<?php echo class_exists('Codeweber_Options') ? Codeweber_Options::style('button') : ' rounded'; ?>" data-bs-toggle="download" data-value="staff-<?php echo esc_attr($staff_post_id); ?>">
