            ...
            <div class="col-md-6">
                ...
                <?php if (!empty($website)) : ?>
                    <div class="d-flex align-items-center mb-4">
                        ...
                        <div>
                            <div class="mb-1 h6"><?php esc_html_e('Website', 'codeweber'); ?></div>
                            <a href="<?php echo esc_url($website); ?>" class="link-body" target="_blank" rel="noopener"><?php echo esc_html($website); ?></a>
                        </div>
                    </div>
                <?php endif; ?>
            </div>
