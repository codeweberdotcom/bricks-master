...
<footer class="bg-<?= $footer_background_color; ?> <?= $text_inverse; ?>">
  <div class="container pt-15 pt-md-17 pb-13 pb-md-15">
    <div class="d-lg-flex flex-row align-items-lg-center">
      ...
      <a href="<?= esc_url($cta_button_url); ?>" class="btn btn-primary<?= function_exists('getThemeButton') ? ' ' . esc_attr(trim(getThemeButton())) : ' rounded-pill'; ?> mb-0 text-nowrap"><?= esc_html($cta_button_text); ?></a>
    </div>
    <!--/div -->
